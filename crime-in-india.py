...
df = pd.read_csv(r"C:\Users\all\Downloads\Crime-Prediction-master\Crime-Prediction-master\final.csv")
...
while (k == 1):
    ...
    if (a == 1):
        ...
        print("The Prediction of crime that will be registered is {} with rmse score of {}".format(
            en.predict([[int(a), int(b)]]), rmse))
        ...
        print(
            "Enter the value of number of Constable,Head Constable,Sub Inspector,Insepctor,SSP,DIG,IG in the same order\n")
        ...
        rape_victims = pd.read_csv(r"C:\Users\all\Downloads\20_Victims_of_rape (1).csv")
        ...
        vic_rape_df = pd.read_csv(r"C:\Users\all\Downloads\20_Victims_of_rape (1).csv")
        vic_rape_2010_total = vic_rape_df[
            (vic_rape_df['Year'] == 2010) & (vic_rape_df['Subgroup'] == 'Total Rape Victims')]
        ...
        vic_rape_2001_total = vic_rape_df[
            (vic_rape_df['Year'] == 2001) & (vic_rape_df['Subgroup'] == 'Total Rape Victims')]
